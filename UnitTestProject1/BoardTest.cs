...
namespace LaskaUnitTests
{
    ...
    public class BoardTest
    {
        ...
        public void Init()
        {
            initW = new Board(Colour.White);
            initW.Init();
            moves = new HashSet<Move>();
            b = new Board(Colour.White);
            b.Init();
        }
        [TestMethod]
        ...
        {           
            Board b = new Board(",,b,b/bb,,b/b,bw,,b/,,bw/bw,,w,w/,w,w/Bww,w,w,", Colour.White);            
        ...
        public void TestLargestChange()  // http://www.lasca.org/show?6JS
        {
            ...
            Board b2 = new Board(s2, Colour.White);
